  ...
  return (
    <group ref={groupRef}>
      <group ref={can1GroupRef}>
        <FloatingCan ref={can1Ref} flavour="blackCherry" floatSpeed={FLOAT_SPEED} />
      </group>


      <group ref={can2GroupRef}>
        <FloatingCan ref={can2Ref} flavour="lemonLime" floatSpeed={FLOAT_SPEED} />
      </group>

      <FloatingCan ref={can3Ref} flavour="grape" floatSpeed={FLOAT_SPEED} />
      <FloatingCan ref={can4Ref} flavour="strawberryLemonade" floatSpeed={FLOAT_SPEED} />
      <FloatingCan ref={can5Ref} flavour="watermelon" floatSpeed={FLOAT_SPEED} />
